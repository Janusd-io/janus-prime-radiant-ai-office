...
- [ingest-2026-05-21-1015-create-hgtft-entity-page](questions/ingest-2026-05-21-1015-create-hgtft-entity-page.md) — propose creating an HGTFT entity page (Janus's customer-facing physical-infrastructure twin); referenced 4× in the Coordination Leverage Model as architectural precedent; currently a wiki gap. Namespace + scope question (vendors/products/projects). [active]
