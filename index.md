...
- [janus-html-deck-brand-guideline](processes/janus-html-deck-brand-guideline.md) — preliminary v0.1 brand guideline for HTML decks (derived from Andrew's SG campaign-plan PPTX): brand orange #F5A623, Montserrat, six slide patterns, drop-in CSS variables.
