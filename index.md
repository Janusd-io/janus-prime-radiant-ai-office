...
_Updated: 2026-05-14 (Rollout-shape decisions captured: personal vaults shelved pending federation-architecture redesign on the GitHub substrate; Project Management rollout also framed as Janus's first Windows deployment. Standup-proposal deck refreshed accordingly. Rosa Wu surname added. Earlier today: Project Management workflow walkthrough ingest — Lysander Liu's 28-phase digital delivery workflow as canonical process page; AI-bounded-role + document-management-gap lessons; Lysander + Spike Zhao entity escalation filed. Naming convention locked: "PM" not used as shorthand — Janus will have Product Management later.)_
