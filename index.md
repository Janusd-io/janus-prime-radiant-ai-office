...
_Updated: 2026-05-15 (Official Janus brand book v1.0 supplied by Michael — filed at sources/articles/2025-janus-brand-guidelines-v1.0.{pdf,md}. Real Janus logo (white + black SVG variants) at assets/branding/. HTML deck brand guideline bumped v0.1 → v1.0 with the official palette: orange #FCB745, navy #013A7D, blue #028CDC, Montserrat. SG deck retrofitted with the real logo (sprite-driven) and correct palette. Scope narrowed to logos / fonts / colour palette — verbal brand / taglines being refreshed by an agency Andrew has lined up. Dhyey Mehta entity stub created (new IT-team joiner). Joyce Woo entity page created at entities/internal/joyce-woo.md — escalation resolved. Two companion Marketing-PR Outputs-layer artefacts ingested today. **(1)** Andrew's Singapore campaign plan v1 PPTX (13 slides, 7 objectives, 100 target accounts, 9-week timeline to 8/9 July luncheon, ~S$23,995 budget). **(2)** Janus Singapore white paper "How agentic AI can answer the storms ahead" (20-page PDF co-authored by Bonaventure + Joyce Woo, built on the back of PM Wong's May Day Rally 2026 speech — clarified: this IS the paper Bonaventure had been referring to, no separate PMO document pending). **(3)** PM Wong's May Day Rally 2026 speech transcript fetched from pmo.gov.sg as upstream substrate for the Janus paper + theme-prompt vocabulary for the SG news-monitoring agent. Two big factual unlocks: **Joyce Woo's formal title is now confirmed CEO, Singapore** + wiki-grade bio (closes the open question on her entity escalation); **`janusd.sg` enters as a third URL** alongside `janusd.com` and `janusdg.com` — the website-architecture question simplifies toward `janusd.com` canonical + `janusd.sg` SG vanity, `janusdg.com` retired. AI Native positioning brief gets its first long-form public surface in the white paper. Yesterday: rollout-shape decisions (personal vaults shelved; Project Management rollout = Janus's first Windows deployment); Project Management workflow walkthrough ingest; Lysander/Rosa/Spike entity pages created.)_
