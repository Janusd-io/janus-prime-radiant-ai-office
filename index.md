...
_Updated: 2026-05-15 (Singapore campaign plan v1 PPTX from Andrew ingested — first delivery of the marketing-prime-radiant Outputs layer. Marketing project hub gains full v1 write-up: 7 campaign objectives, 100-account target list, 9-week timeline to the 8/9 July luncheon, ~S$23,995 / AED 69,210 budget, 5-venue shortlist. Joyce Woo entity escalation filed — "recognised face of Janus Digital in Singapore" per the v1 deck + potential Vivian Balakrishnan introducer. Website-architecture question gets a status update: v1 deck lists both `janusd.com` and `janusdg.com` as week-1 landing-page targets — ahead of the architectural alignment with Bonaventure. Yesterday: rollout-shape decisions (personal vaults shelved pending federation redesign on the GitHub substrate; Project Management rollout = Janus's first Windows deployment); Project Management workflow walkthrough ingest — Lysander Liu's 28-phase digital delivery process; AI-bounded-role + document-management-gap lessons; Lysander/Rosa/Spike entity pages created. Naming convention locked: "PM" not used as shorthand.)_
...
- [ingest-2026-05-15-joyce-woo](questions/ingest-2026-05-15-joyce-woo.md) — propose creating `entities/internal/joyce-woo.md`; Singapore-side senior stakeholder, "recognised face of Janus Digital in Singapore" per the v1 campaign plan; BW/JW direct-outreach pairing; potential Vivian Balakrishnan introducer. Recommendation = create with title TBC. [active]
