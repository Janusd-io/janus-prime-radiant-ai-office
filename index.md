...
- [ingest-2026-05-15-joyce-woo](questions/ingest-2026-05-15-joyce-woo.md) — propose creating `entities/internal/joyce-woo.md`; title CONFIRMED 2026-05-15 as **CEO, Singapore** of Janus Digital Singapore Pte. Ltd. per white-paper co-authorship; 4+ decades banking bio (DBS Finance → Merrill Lynch → OCBC Private Bank → Citi/UBS/MS/BoS → Jachin Capital → Leo Wealth → Janus); confidence upgraded medium→high (bio). Recommendation = create now. [active]
