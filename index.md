...
_Updated: 2026-05-19 (**PM team feedback ingested.** Lysander Liu's bilingual feedback deck (KSR-PM-2026-0514-001) responds to the 14 May standup-proposal: 28-phase content endorsed (9/10), critical G1-G4 gate correction lands (phases 23–28 = G4 *prerequisites*, not "Stage 5 Closure"), A/B/C three-pillar architecture recommended, ★ PMO Dashboard (A-4) added as net-new, KSC confirmed as first backfill project. Workflow process page corrected to G1-G4 framing + post-G4 closeout gap flagged. Source filed at sources/misc/2026-05-18-pm-team-feedback-knowledge-architecture.{html,md}. Yesterday: **CEO-level Prime Radiant validation.** Jehad demo'd to Bonaventure + Joyce Woo — entity nodes auto-sourced from Joyce's white paper, Obsidian graph view, HTML deck. Both received it positively. GitHub sync confirmed as canonical vault backend at CEO level. Bonaventure articulated the long-arc architectural intent: **one unified global knowledge base, market-specific UI layer, open access across departments**. Singapore two-layer model: SG team reads global KB + local SG vault feeds back upward. Obsidian single-repo limitation deferred as known constraint. CEO direction filed as [[2026-05-18-ceo-global-kb-unified-market-ui]]. **NanoClaw** (by NanocoAI) identified as Slack bot sprawl solution — one personal AI chief-of-staff per person via unified Slack interface; AIR-103 created; Gate 1 PASS all 5 criteria; Status: Evaluating. Filed: [[nanoclaw]] vendor entity + [[2026-05-18-nanoclaw-as-personal-ai-coa-candidate]] decision. **Website scope expanded** to full React/TypeScript rebuild with GDPR consent popup + Mailchimp integration (Singapore campaign compliance). Filed: [[2026-05-18-website-react-typescript-full-rebuild]]. **Notion deprecation (end-May 2026) reconfirmed by Bonaventure.** Morning AIO standup skipped (company town hall) — this CEO meeting is the day's primary knowledge-capture surface. Standup skill v3.17. AIP-21 conflict 12th consecutive run — manual Linear closure required by human. Yesterday: brand book v1.0, SG deck retrofit, Joyce Woo entity created, PM white paper + campaign plan + PM May Day Rally speech ingested.)_
...
- [mailchimp](entities/vendors/mailchimp.md) — email marketing platform (Intuit); Marketing candidate (AIO-100, Backlog, Gate 1 BLOCKED). [active, low]
...
- [resend](entities/vendors/resend.md) — developer-focused transactional email API; Technology candidate (AIO-101, Backlog, Gate 1 BLOCKED). [active, low]
