...
> **READ THIS FIRST when starting any new SaaS / CRM / admin / dashboard project.** This is a self-contained build-kit distilled from a deep study of [[Twenty CRM Overview|Twenty CRM]]. It contains paste-ready assets, not just descriptions, so a fresh Claude session can reproduce Twenty-grade quality without access to the original repo.
>
...
7. **[[Twenty CRM PROJECT_REFERENCE|Full Twenty Reference]]** — the deep 21-section reference for anything not covered here.
...
- [[Twenty CRM Overview]] · the SaaS Default Stack (Next.js 15 / Prisma / Clerk / Tailwind+shadcn / Stripe / Resend) · [[saas-blueprint|SaaS Blueprint concept]]
