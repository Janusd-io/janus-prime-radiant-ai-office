...
> Two ready-to-drop `DESIGN.md` templates, one per register (from Twenty's product app vs its marketing site philosophy). **Pick the register per surface**, paste into the new repo, fill the brackets. See [[_SaaS Blueprint]] · [[Design Tokens]].
...
## Related
- [[_SaaS Blueprint]] · [[Design Tokens]] · [[Twenty CRM Overview]]
