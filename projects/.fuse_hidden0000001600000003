...
related: [llm-wiki, michael-bruck, jehad-altoutou, obsidian, linear, notion, 2026-05-05-kb-direction-markdown-progressive-exposure-not-rag, 2026-05-05-notion-degrades-as-ai-searchable-kb, peer-to-peer-mesh-federation-pattern, 2026-05-11-bonaventure-prime-radiant-shoutout, 2026-05-11-notion-restricted-to-aio-no-broad-rollout, 2026-05-11-internal-branding-prime-radiant-vs-nomi-vs-brain, ai-native-janus-positioning, 2026-05-12-html-as-presentation-format-adopted, pm-digital-delivery-workflow, 2026-05-14-ai-bounded-role-in-pm, 2026-05-14-pm-document-management-gap, euclid-wong]
---
...
- **PM Prime Radiant initialisation plan locked (2026-05-14).** [[pm-digital-delivery-workflow|The full 28-phase PM digital delivery workflow]] is now captured as a process page, derived from Lysander Liu's ~60-minute walkthrough on 14 May. This is the **canonical content the PM instance is initialised against** — once PM enrolls (post-tooling-install), the workflow gives the instance a running start: schema, entity vocabulary, AI-bounded role, decision-trail discipline. The session also surfaced two structural insights captured as lessons: [[2026-05-14-ai-bounded-role-in-pm|AI's bounded role (~30–60%, first-draft only)]] and [[2026-05-14-pm-document-management-gap|document-management as an acknowledged ISO gap]]. Lysander and Spike Zhao pending entity-page creation via [[ingest-2026-05-14-lysander-liu-and-spike-zhao]]. [[euclid-wong|Euclid]] confirmed as PM Lead in addition to IT-Ops Head — wears both hats, simplifies federation.
