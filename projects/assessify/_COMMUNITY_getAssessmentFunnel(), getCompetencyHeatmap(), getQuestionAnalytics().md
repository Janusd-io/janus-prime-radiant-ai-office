...
# getAssessmentFunnel(), getCompetencyHeatmap(), getQuestionAnalytics()
...
```dataview
TABLE source_file, type FROM #community/getAssessmentFunnel(),_getCompetencyHeatmap(),_getQuestionAnalytics()
SORT file.name ASC
```
