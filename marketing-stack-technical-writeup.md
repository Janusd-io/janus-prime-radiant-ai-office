...
6. **Pages needed:** `/singapore` landing, `/singapore/thank-you`, `/privacy`. Sim's privacy policy review needs to happen before paid traffic.
...
5. **Privacy policy review.** Sim's not in yet. We're using Andrew's working draft for the soft Singapore launch. Need Sim's review before paid traffic.
