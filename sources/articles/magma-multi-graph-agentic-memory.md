...
slug: magma-multi-graph-agentic-memory
source_type: arxiv-paper
source_url: https://arxiv.org/abs/2601.
arxiv_id: 2601.03236v2
authors: Dongming Jiang, Yi Li, Guanpeng Li, Bingzhe Li
institutions: UT Dallas, University of Florida
created: 2026-05-13
updated: 2026-05-13
departments: [ai-office]
tags: [research-paper, agent-memory]
---

> _Imported 2026-05-13 via Obsidian Web Clipper. Topic: agent memory; multi-graph (semantic/temporal/causal/entity) memory architecture. Embedded image references are remote arxiv URLs (egress to arxiv.org currently blocked, so images are not local mirrors)._
