...
slug: transformers-are-graph-neural-networks
...
tags: [research-paper, theoretical-framing]
---

> _Imported 2026-05-13 via Obsidian Web Clipper. Topic: theoretical framing; Transformers as GNNs on fully-connected token graphs; hardware-lottery argument. Embedded image references are remote arxiv URLs (egress to arxiv.org currently blocked, so images are not local mirrors)._
