---
type: question
title: "Ingest escalation — create entity page for Joyce Woo?"
slug: ingest-2026-05-15-joyce-woo
created: 2026-05-15
updated: 2026-05-15
...
# Ingest escalation — create entity page for Joyce Woo?

## Proposed action

Create a new internal entity page `entities/internal/joyce-woo.md` for Joyce Woo. High-stakes per `CLAUDE.md` §5.1 (new internal entity creation). Multiple substantive references across the wiki now exist; the Singapore campaign plan v1 formalises her as the recognised face of Janus Digital in Singapore.

## Sources backing the page

- **[[2026-05-15-singapore-marketing-launch-plan-v1]]** — Campaign objective #2 names her explicitly: *"Position Joyce Woo as the recognised face of Janus Digital in Singapore, through coordinated leadership announcements, founder-led outreach, and direct engagement with senior institutional contacts."* Bonaventure + Joyce ("BW/JW") share direct-email-outreach ownership across the campaign timeline.
- **[[2026-05-12-bonaventure-ai-native-call]]** — Michael flagged Joyce as the potential introducer to [[vivian-balakrishnan|Dr. Vivian Balakrishnan]] (Singapore Foreign Minister, LLM-wiki advocate): *"Maybe Joyce can get you a meeting with him. Might be interesting."*
- Implicit additional context: she has been referenced in earlier conversations Michael has had with Andrew about Singapore outreach; the campaign plan crystallises her as a named Singapore-side senior stakeholder.

## Proposed page outline

- **Role**: Singapore-side senior stakeholder; "the recognised face of Janus Digital in Singapore" per the v1 campaign plan. Specific job title to be confirmed once Deel is set up (or via direct ask).
- **Country**: Singapore-primary.
- **Working pattern**: senior — formally positioned alongside [[bonaventure-wong|Bonaventure]] in the campaign's BW/JW direct-outreach pairing. Personal-relationship network into senior SG institutional contacts.
- **Network connections captured so far**:
  - Potential introducer to [[vivian-balakrishnan|Dr. Vivian Balakrishnan]] (Foreign Minister of Singapore).
  - Co-owner with Bonaventure on direct email outreach to the 100-account target list.
  - Likely involvement in the 8/9 July luncheon attendee list curation.
- **Campaign-specific responsibilities** (per the v1 plan):
  - Target account list review by end-of-day Wed 20 May (alongside Bonaventure).
  - Direct email outreach to known contacts in the target group.
  - Co-host at the 8/9 July luncheon.
- **Federation status**: SG-side; primary cross-reference to [[singapore-news-monitoring]] + [[marketing-prime-radiant]] + [[bonaventure-wong]]'s relationship-management web.
...
1. **Create the page now** — recommended. Multiple inbound references from durable wiki content; the v1 campaign plan formalises her positioning; an entity escalation page that lingers in the open-questions queue while she's actively in the rollout reads as a wiki gap.
2. **Defer until her formal title surfaces** — possible but suboptimal. The page can land at confidence:medium with title TBC; titles in this wiki are amendable.
3. **Wait for the first source that captures her own voice** (a meeting transcript she's in, or a doc she authored) — most cautious but slowest; she's already being referenced as a primary stakeholder.
...
- [[2026-05-15-singapore-marketing-launch-plan-v1]] — source.
- [[marketing-prime-radiant]] — project hub.
- [[singapore-news-monitoring]] — SG market intelligence project.
- [[bonaventure-wong]] — Joyce's senior co-stakeholder.
- [[vivian-balakrishnan]] — connection route Joyce can enable.
- [[2026-05-12-singapore-as-lead-market]] — strategic frame.
- [[ai-native-janus-positioning]] — three-pillar spine the campaign delivers.
