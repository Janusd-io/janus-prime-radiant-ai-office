...
type: source
source_type: laptop
title: Janus Digital — AI Tool Evaluation & Approval Framework
slug: janus-digital-ai-tool-evaluation-approval-framework
created: 2026-04-03
captured_by: jehad-altoutou
audience: personal
original_path: /Users/jehad/Desktop/Janus Digital — AI Tool Evaluation & Approval Framework.docx
original_size: 380972
original_ext: .docx
category: docs
...
**Document Status:** DRAFT v0.1 **Supersedes:** Section 5.2.4
(Justification Protocol) **Owner:** AI Office — AI & Technology **Last
Updated:** 2 April 2026

## 1. Purpose & Governing Principle

This framework establishes the mandatory, multi-stage evaluation process
through which any AI tool or platform is assessed for adoption within
Janus Digital. It replaces the high-level criteria in Section 5.2.4 of
the AI & Automated Systems Policy with a granular, gate-based process
designed for transparency, repeatability, and auditability.

**Default Posture:** No AI tool, platform, or service may be used by any
employee unless it has been formally approved and listed in the Janus
Digital AI Registry. The burden of proof lies with the evaluation
process, not with the requesting employee.
...
The evaluation process consists of four sequential stages, each
terminated by a binary gate decision. Failure at any gate halts
progression and returns the candidate to a holding state or rejection.
...
- An employee identifies a candidate tool and submits a suggestion via
  the designated Slack AI Hub channel.

- The AI & Technology office identifies a candidate through its own
...
**Decision type:** Binary pass/fail. All criteria must be met. Failure
on any single criterion is an immediate rejection. No scoring. No
weighting.
...
To assess the candidate against deeper technical, operational, and
strategic criteria. Unlike Gate 1, these criteria use a **tiered
classification**: **Must Have**, **Should Have**, and **Nice to Have**.
...
**Decision type:** Structured. All **Must Have** criteria are binary
(pass/fail). **Should Have** and **Nice to Have** criteria are scored
0–5 and inform the overall recommendation but do not independently block
progression.
...
To validate the candidate in a controlled environment using
non-sensitive data, and to obtain structured feedback from the domain
expert(s) who would use the tool in production.
...
The following form is completed by each domain expert following the
sandbox test period. Responses are structured to enable aggregation and
comparison.
...
**Decision type:** Qualitative review by Evaluator, informed by
structured domain expert feedback.
...
Approved tools are not permanent. The following triggers initiate a
re-evaluation:

| **Trigger** | **Action** |
|----|----|
| **Scheduled Review** — Every 12 months from the date of Registry listing. | Full re-evaluation from Stage 2 onwards. |
...
The following node definitions are provided for direct translation into
a flowchart (ISO 5807 / BPMN compatible):
