...
original_path: /Users/jehad/assessify/src/generated/prisma/models/LeaveBalance.ts
original_size: 55532
original_ext: .ts
category: code
...
_Extracted from `[[assessify|assessify]]/src/generated/prisma/models/LeaveBalance.ts` on 2026-05-14._
...
export type LeaveBalanceWhereInput = {
  ...
  allocated?: Prisma.IntFilter<"LeaveBalance"> | number
...
export type LeaveBalanceScalarWhereWithAggregatesInput = {
  ...
  allocated?: Prisma.IntWithAggregatesFilter<"LeaveBalance"> | number
...
export type LeaveBalanceCreateInput = {
  ...
  employee: Prisma.EmployeeCreateNestedOneWithoutBalancesInput
}
...
export type LeaveBalanceUpdateInput = {
  ...
  employee?: Prisma.EmployeeUpdateOneRequiredWithoutBalancesNestedInput
}
...
export type LeaveBalanceOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "employeeId" | "year" | "leaveType" | "allocated" | "used" | "updatedAt", ExtArgs["result"]["leaveBalance"]>
...
export interface LeaveBalanceFieldRefs {
  ...
  readonly allocated: Prisma.FieldRef<"LeaveBalance", 'Int'>
