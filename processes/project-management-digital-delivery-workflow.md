...
End-to-end project delivery workflow for the Janus Project Management function, captured from Lysander Liu's ~60-minute walkthrough on 14 May 2026 with [[michael-bruck|Michael]], [[euclid-wong|Euclid]], and Spike Zhao. This page is the canonical reference document the Project Management Prime Radiant instance will be initialised against — i.e., once the team is enrolled, the workflow below is the *operational shape* their Prime Radiant captures, federates, and synthesises against.
...
> **Naming convention.** The abbreviation "PM" is *not* used as shorthand on this page because Janus will eventually have a Product Management function and we want to avoid the collision. Throughout: "Project Management" for the function; "Project Manager" for the role; "the project team" for the wider working group. Source filenames keep "pm-" as historical artefacts (immutable per source-immutability rule).
>
> **Note on scope.** This documents how Project Management actually operates today — process, artefacts, dependencies, where AI helps and where it does not. It is *not* a redesign. The Prime Radiant rolls *over* this workflow, not in place of it. Phase numbering below approximates Lysander's narration order; many phases run in parallel rather than sequentially.
...
**Process:**
- Inputs submitted to the shared project directory (currently the Google Drive project folder; will become the GitHub-backed Project Management vault structure under [[janus-prime-radiant-build|Prime Radiant]]).
...
- Formal project-initiation approval email + Project Manager confirmation — this is the trigger that moves the project from presale to delivery.

**Output:** Project officially moves from presale → delivery; Project Manager is assigned.
...
## Phase 2 — Project initiation (Project-Manager-owned)

**First thing the Project Manager does** once assigned: produce the **project charter**.
...
Once the presale inputs are inventoried, gaps will be identified — contract-signing inputs are *never* complete. Project Manager enters a loop:
...
**Where AI helps here:** existing tools automate part of the gap-identification work (rough estimate per Lysander: 30–60% of preparation work is AI-automatable; see [[2026-05-14-ai-bounded-role-in-project-management]]).
...
After Project Manager and core delivery team have absorbed the inputs, a formal handoff meeting is convened.
...
**Critical principle (Lysander):** Don't open this meeting cold. Project Manager and core team must absorb materials *before* the meeting — the meeting is for confirming understanding and surfacing scope-level questions, not for first-time briefing.
...
**The most important phase of the Project Manager's work** (Lysander, verbatim): *"If you cut corners here, all the risks will happen at the end of the project — that's catastrophic."*

**Plans the Project Manager must produce:**
- Scope
...
**Principle:** Project Manager independence + deep thinking required. This is the Project Manager's locus of understanding the project; AI cannot substitute.
...
### 8.1 Consolidation
- Project Manager consolidates all the planning streams (Project Manager plan + construction plan + hardware plan + platform plan + digital delivery plan + business delivery plan).
- Project Manager reviews other sections for reasonableness.
- Project Manager integrates and confirms; if all checks pass, triggers the plan review.
...
- **Required attendees:**
  ...
  - Project Manager
  - Global (Project Management team representative — to evaluate the plan + identify unidentified risks)
...
- **Customer-side preparation:** office space at site, badge access, warehouse arranged. Project Manager coordinates these well ahead of equipment arrival.
...
**Governance note:** Global procurement function does not currently exist as a discrete role at Janus — the Project Manager negotiates supplier deals directly. Construction team is built by Janus (e.g. the Ricsos partner sourced previously). This is an evolving area.
...
- Project Manager attends customer's morning meeting(s), tracks EAS announcements, daily reports.
...
Critical milestone before configuration begins. Project Manager facilitates a customer sign-off on the deliverable scope (more granular than the contract). This becomes the **basis for the final verification standard**.
...
- Project Manager facilitates; team supports.
- Output: **UAT report**.

## Phase 25 — Training

**Training matrix produced by the Project Manager:**
...
**Execution:** Project Manager and business consultant co-deliver.

## Phase 26 — Trial run

- **Duration:** ~1 month.
- **Pattern:** continuous use → issue capture → fix → re-use.
- **Plan + scope:** Project Manager produces a trial run plan defining objectives, participating roles, success criteria.
...
Project Manager produces a trial run summary report:
...
Per Lysander, captured in [[2026-05-14-ai-bounded-role-in-project-management|the bounded-role lesson]]:
...
- [[2026-05-14-ai-bounded-role-in-project-management]] — bounded-role lesson.
- [[2026-05-14-project-management-document-management-gap]] — document-management gap lesson.
- [[euclid-wong]] — Project Management Lead (wears IT-Ops Head + Project Management Lead hats).
- [[janus-prime-radiant-build]] — program-level hub. Project Management is rolling out as the third instance after AI Office (live) and Marketing (in flight).
- [[peer-to-peer-mesh-federation-pattern]] — Project Management × AIO mesh subfolder pending once instance is live.
