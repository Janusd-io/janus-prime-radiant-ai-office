...
A one-week scoped experiment to test whether the [[singapore-news-monitoring]] agentic workflow — the Marketing instance's first live Layer-3 workflow, designed against the [[coordination-three-layer-model]] (AIO-canonical) — is still operating inside [[bonaventure-wong|Bonaventure's]] intended frame, or whether the frame has drifted.

> **Federation note (2026-05-22):** this project was incubated in the AI Office Prime Radiant and migrated to the Marketing instance on 2026-05-22 as part of the singapore-monitoring federation handoff. Andrew is the operational Framer of Record; Bonaventure remains the strategic framer (cadence to be confirmed). The audit's deliverable (`pulse/YYYY-MM-DD-singapore-monitoring-frame-audit.md`) lives in this Marketing vault, not the AIO vault.
