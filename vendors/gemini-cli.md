...
departments: []
url: https://linear.app/janusd/issue/AIR-12/gemini-cli
created: 2026-02-25
updated: 2026-05-04
...
* Terminal integration — interacts with local filesystem
* Multimodal input — images, screenshots, documents
...
* Local execution
* Paid API calls not used for training; free tier may be used for product improvement
