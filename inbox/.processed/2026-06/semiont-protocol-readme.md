---
title: "semiont/docs/protocol/README.md at main"
source: "https://github.com/The-AI-Alliance/semiont/blob/main/docs/protocol/README.md"
author:
published:
created: 2026-06-08
description: "Semiont supports human+ai collaborative knowledge work.  Use it as: a Wiki, Knowledge Base, Context Graph, Semantic Layer, or Agentic Memory. - semiont/docs/protocol/README.md at main · The-AI-Alliance/semiont"
tags:
  - "clippings"
---
## Semiont Protocol
...
- **[flows/README.md](https://github.com/The-AI-Alliance/semiont/blob/main/docs/protocol/flows/README.md)** — per-flow contracts (frame, yield, mark, match, bind, gather, browse, beckon)
- **[EVENT-BUS.md](https://github.com/The-AI-Alliance/semiont/blob/main/docs/protocol/EVENT-BUS.md)** — wire-level event protocol: channel naming, `correlationId` / `_userId` conventions, `_trace` carrier, gateway injection, resource scoping
- **[CHANNELS.md](https://github.com/The-AI-Alliance/semiont/blob/main/docs/protocol/CHANNELS.md)** — channel inventory: persisted events, ephemeral signals, correlation responses, resource broadcasts
- **[TRANSPORT-CONTRACT.md](https://github.com/The-AI-Alliance/semiont/blob/main/docs/protocol/TRANSPORT-CONTRACT.md)** — abstract `ITransport` behavioral guarantees every transport must honor
- **[TRANSPORT-HTTP.md](https://github.com/The-AI-Alliance/semiont/blob/main/docs/protocol/TRANSPORT-HTTP.md)** — HTTP+SSE wire format
- **[API.md](https://github.com/The-AI-Alliance/semiont/blob/main/docs/protocol/API.md)** — REST endpoint reference
- **[W3C-WEB-ANNOTATION.md](https://github.com/The-AI-Alliance/semiont/blob/main/docs/protocol/W3C-WEB-ANNOTATION.md)** + **[W3C-SELECTORS.md](https://github.com/The-AI-Alliance/semiont/blob/main/docs/protocol/W3C-SELECTORS.md)** — W3C compliance story
...
**[Eight Collaborative Flows](https://github.com/The-AI-Alliance/semiont/blob/main/docs/protocol/flows/README.md)** — humans and AI agents work as peers through eight composable workflows:
...
**[Semiont CLI](https://github.com/The-AI-Alliance/semiont/blob/main/apps/cli/README.md)** — pipe the full annotation pipeline from the terminal:
...
**[Semiont SDK](https://github.com/The-AI-Alliance/semiont/blob/main/packages/sdk/README.md)** — type-safe TypeScript SDK organized by the eight verbs. `SemiontClient.signInHttp(...)` is the credentials-first one-line construction for scripts. Long-running scripts that span token expiry use `SemiontSession.signInHttp(...)` instead — same shape, plus refresh and persistence.

The SDK is RxJS-native — live queries and progress streams are real Observables — but its return values implement `PromiseLike<T>`, so `await semiont.X.Y(...)` works directly without learning RxJS. Reach for `.subscribe(...)` only when you want progress events or live updates, and `.pipe(...)` only when you want operator composition. The deeper guides live alongside the package: **[Usage.md](https://github.com/The-AI-Alliance/semiont/blob/main/packages/sdk/docs/Usage.md)** is the per-namespace tour, **[REACTIVE-MODEL.md](https://github.com/The-AI-Alliance/semiont/blob/main/packages/sdk/docs/REACTIVE-MODEL.md)** explains the Promise-shape-over-Observable design, and **[CACHE-SEMANTICS.md](https://github.com/The-AI-Alliance/semiont/blob/main/packages/sdk/docs/CACHE-SEMANTICS.md)** is the live-query cache contract.
...
**[Agent Skills](https://github.com/The-AI-Alliance/semiont/blob/main/docs/protocol/skills)** — ready-made skill definitions that agentic coding assistants like Claude Code can use to drive the full pipeline without writing integration code.

See the **[Local Semiont Overview](https://github.com/The-AI-Alliance/semiont/blob/main/docs/system/LOCAL-SEMIONT.md)** for alternative setup paths.