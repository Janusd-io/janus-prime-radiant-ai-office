---
title: "mnemon-dev/mnemon: LLM-supervised persistent memory for AI agents — graph-based recall, cross-session knowledge, single binary. Works with Claude Code, OpenClaw, and any CLI agent."
source: "https://github.com/mnemon-dev/mnemon"
author:
published:
created: 2026-05-12
description: "LLM-supervised persistent memory for AI agents — graph-based recall, cross-session knowledge, single binary. Works with Claude Code, OpenClaw, and any CLI agent. - mnemon-dev/mnemon"
tags:
  - "clippings"
---
[![Mnemon Logo](https://github.com/mnemon-dev/mnemon/raw/master/docs/logo/logo.svg)](https://github.com/mnemon-dev/mnemon/blob/master/docs/logo/logo.svg)

## Mnemon

**English** | [中文](https://github.com/mnemon-dev/mnemon/blob/master/docs/zh/README.md)
...
[![LLM-Supervised Architecture — three patterns compared, with Mnemon hooks, protocol boundary, and deterministic memory engine](https://github.com/mnemon-dev/mnemon/raw/master/docs/diagrams/llm-supervised-concept.jpg)](https://github.com/mnemon-dev/mnemon/blob/master/docs/diagrams/llm-supervised-concept.jpg)  
...
[![Knowledge Graph — 87 insights connected by temporal, entity, semantic, and causal edges](https://github.com/mnemon-dev/mnemon/raw/master/docs/diagrams/10-knowledge-graph.jpg)](https://github.com/mnemon-dev/mnemon/blob/master/docs/diagrams/10-knowledge-graph.jpg)  
<sub>A real knowledge graph built by Mnemon — 87 insights, 2150 edges across four graph types.</sub>

See [Design & Architecture](https://github.com/mnemon-dev/mnemon/blob/master/docs/DESIGN.md) for details.
...
**How do I customize the behavior?** Edit the generated guideline (`~/.mnemon/prompt/guide.md` in current setup flows) or use the installable [GUIDELINE.md](https://github.com/mnemon-dev/mnemon/blob/master/docs/framework/GUIDELINE.md) as the source. The skill file should stay focused on command syntax.
...
See [Development and Deployment](https://github.com/mnemon-dev/mnemon/blob/master/docs/DEPLOYMENT.md) for Docker, Compose, Ollama embedding, and release setup.

## Documentation

- [Mnemon Memory Harness](https://github.com/mnemon-dev/mnemon/blob/master/docs/framework/HARNESS.md) — skill-first memory harness design and installation guideline
- [Harness Install Guide](https://github.com/mnemon-dev/mnemon/blob/master/docs/framework/INSTALL.md) — agent-facing installation contract
- [Memory Guideline](https://github.com/mnemon-dev/mnemon/blob/master/docs/framework/GUIDELINE.md) — recall/writeback judgment policy
- [Self-Evolution Harness Design](https://github.com/mnemon-dev/mnemon/blob/master/docs/design/self-evolution-harness/SELF_EVOLUTION_HARNESS.md) — consolidated v0.2 architecture for install, memory loop, skill evolution, and risk control
- [Agent Systems Research](https://github.com/mnemon-dev/mnemon/blob/master/docs/design/self-evolution-harness/research/agent-systems/README.md) — condensed source index for memory and self-evolution research
- [Design & Architecture](https://github.com/mnemon-dev/mnemon/blob/master/docs/DESIGN.md) — current engine architecture, algorithms, integration design
- [Usage & Reference](https://github.com/mnemon-dev/mnemon/blob/master/docs/USAGE.md) — CLI commands, embedding support, architecture overview
- [Architecture Diagrams](https://github.com/mnemon-dev/mnemon/blob/master/docs/diagrams) — system architecture, pipelines, lifecycle management

## Star History

[

![Star History Chart](https://camo.githubusercontent.com/9090c15f4068c062c7ad427cf14a07b2e1eff77f0e12a57b15f228b01057f9fe/68747470733a2f2f6170692e737461722d686973746f72792e636f6d2f63686172743f7265706f733d6d6e656d6f6e2d6465762f6d6e656d6f6e26747970653d64617465266c6567656e643d746f702d6c656674)

](https://www.star-history.com/?repos=mnemon-dev%2Fmnemon&type=date&legend=top-left)

## References

Mnemon combines the paradigm of one paper with the methodology of another, grounded in the structural insight that graph memory is isomorphic to LLM attention. See [Theoretical Foundations](https://github.com/mnemon-dev/mnemon/blob/master/docs/DESIGN.md#25-theoretical-foundations) for details.
