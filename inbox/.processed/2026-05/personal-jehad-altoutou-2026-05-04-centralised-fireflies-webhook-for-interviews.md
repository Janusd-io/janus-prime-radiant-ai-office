...
sources: [pr-backup-2026-05-11-decision-2026-05-04-centralised-fireflies-webhook-for-interviews]
related: [fireflies, hr-recruitment-pipeline, claude-code]
audience: [department]
...
**Decision date:** 2026-05-04 (chosen); 2026-05-05 (architecture confirmed). **Decided by:** Michael Bruck, Jehad Altoutou.

## What

Interview transcripts will be captured by a centralised [[fireflies|Fireflies]] setup using a webhook architecture: a dedicated invitee email auto-records interviews and triggers a post-assessment skill on completion.
...
- [[hr-recruitment-pipeline]] — the parent pipeline this webhook feeds.
