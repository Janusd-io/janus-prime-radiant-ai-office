...
sources: [pr-backup-2026-05-11-project-it-department-standup-pilot]
related: [andrew-soane, jehad-altoutou, michael-bruck, andrey-timokhov, euclid-wong, monday-com, notion, standup-skill]
audience: [department]
...
Hub for rolling out the AI Office's standup methodology — `/standup` skill + [[monday-com]] Automations board pattern + [[notion]] sub-page journal — to the IT department. Sibling pilot to [[andrew-soane]]'s Marketing rollout.
...
- **Morning-meeting co-design** with [[andrey-timokhov]] — IT's existing meeting cadence is the hook; the pilot adapts to that rather than imposing AIO's cadence.
...
- **Skill v3 ISO alignment** — the IT pilot uses the standup skill, which is still iterating toward ISO-aligned production.
- **Monday production push** — Andre's IT team would prefer not to use a sandbox tool for live work.
...
- Andrew's Marketing pilot is the sibling rollout.
