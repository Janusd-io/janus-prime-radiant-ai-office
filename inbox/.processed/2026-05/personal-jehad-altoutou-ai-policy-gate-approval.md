...
related: [ai-tool-evaluation-framework, ai-policy-gate, claude-cowork, euclid-wong, michael-bruck, notion, linear]
audience: [department]
captured_by: jehad-altoutou
sources: [pr-backup-personal-processes-ai-policy-gate-approval, pr-backup-aio-q-ingest-2026-05-06-2301-cowork-approval-governance-process]
---
...
| 3 | Integration alignment | Does the tool integrate with Janus's existing surfaces (Google Workspace / Slack / Linear / Monday) per [[ai-tool-evaluation-framework]] G1.1–G1.5 baseline? |
| 4 | Usage scope clarity | Is the intended scope defined: who uses it, for what tasks, with which data classes? |

Authoritative criteria live in the AI Policy doc; this page summarises structure.

## The 8-step approval flow

1. Candidate identified — [[michael-bruck]] / AIO surfaces the tool.
...
6. IT approved-tools list updated — [[euclid-wong]] / IT adds to v3+ list.
7. Entra / browser policy updated — if browser-mode access restrictions apply.
8. AI Hub Slack announcement — per [[ai-tool-evaluation-framework]] Stage 4.

## Four-system coordination
...
- **Linear AIR** ([[linear]]) — the per-tool record where the approval is timestamped.
...
The four must be kept consistent. A tool approved in Linear AIR but missing from the IT list is functionally not approved (users can't access it); a tool on the IT list but not in AIR has no policy paper trail.

## Inaugural case study: Cowork

[[claude-cowork|Cowork]] is in active use across the AI Office (it's how this wiki is being maintained) but hasn't been through the AI Policy gate. Per Monday item `2891633403` (In Definition as of 2026-05-06):
...
- **Definition of done:** all 8 steps complete.

Cowork's clearance is the inaugural case for this process. Lessons from running it feed back into refining this page.
