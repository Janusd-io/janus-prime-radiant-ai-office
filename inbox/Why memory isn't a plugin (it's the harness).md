...
created: 2026-06-05
description: "Ever since we've been working on MemGPT (now @Letta_AI), a common question @charlespacker and I have gotten is: \"how can I plug your memory ..."
tags:
  - "clippings"
---
![Image](https://pbs.twimg.com/media/HE9HP2sbAAAYlN-?format=jpg&name=large)

Ever since we've been working on MemGPT (now [@Letta\_AI](https://x.com/@Letta_AI)), a common question [@charlespacker](https://x.com/@charlespacker) and I have gotten is:
...
If you're what using a memory-first agent harness feels like, you can check out Letta Code (works with Codex plans + BYOK!) and follow [@Letta\_AI](https://x.com/@Letta_AI).
