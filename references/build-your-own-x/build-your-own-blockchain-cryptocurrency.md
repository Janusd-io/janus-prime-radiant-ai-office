---
type: reference
title: Build Your Own — Blockchain / Cryptocurrency
...
audience: [department]
tags: [build-your-own-x, learning, from-scratch]
---

# Build Your Own — Blockchain / Cryptocurrency

> Hashing, consensus (PoW/PoS), immutable ledgers, P2P.

**Related skills:** [[backend-architect]]
**Languages:** ATS, Crystal, Go, Java, JavaScript, Kotlin, Python, Ruby, Rust, Scala, TypeScript
**Tutorials:** 21
...
## Related
- [[build-your-own-x|Build Your Own X Index]]
