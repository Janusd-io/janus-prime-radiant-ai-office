...
> The patterns that define Twenty-grade quality, each with a "use when" so a fresh chat applies them correctly (not cargo-cult). Implementations in [[code-recipes]]. See [[saas-blueprint-guide]].
...
## Related
- [[saas-blueprint-guide]] · [[code-recipes]] · [[design-tokens]] · [[twenty-crm]]
