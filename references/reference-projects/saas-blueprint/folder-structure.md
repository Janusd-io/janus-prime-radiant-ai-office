...
> The repo skeleton + naming conventions to scaffold a new the SaaS Default Stack (Next.js 15 / Prisma / Clerk / Tailwind+shadcn / Stripe / Resend) project, mirroring Twenty's module discipline. See [[saas-blueprint-guide]].

## Top-level layout (Next.js 15 App Router monorepo-ready)

```
my-saas/
├── CLAUDE.md                  # paste the 7 non-negotiables from [[saas-blueprint-guide]]
...
## Related
- [[saas-blueprint-guide]] · [[code-recipes]] · [[twenty-crm]]
